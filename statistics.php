...
<body>
    ...
    <section id="statistics">
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") {
            ...
            if (!empty($methods_list)) {
                ...
                echo '<p>No discovery methods were selected. Please fill out the form again <a href="query-planets.php">here</a> and select at least one discovery method.</p>';
            }
        } else {
    ...
    <section id="map">
        ...
        <script type="module">
            ...
            // This sets up the controls (i.e. you can click and drag to move around and view the planets from different angles)
            ...
            function toColor(method) {
                ...
                const colors = {
                    ...
                    'Microlensing': new THREE.Color(0x0000ff), // BLUE
            ...
            const material = new THREE.PointsMaterial({
                size: 0.5, // The size of each particle
